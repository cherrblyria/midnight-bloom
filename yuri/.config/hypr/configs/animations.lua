...
anim("workspaces", true, 5, "spring", nil, "smoother")
anim("windows", true, 5, "spring", nil, "smoother", "slide")
anim("windowsOut", true, 5, "spring", nil, "smoother", "popin 50%")
anim("layers", true, 5, "spring", nil, "smooth", "popin 60%")
anim("layersIn", true, 5, "spring", nil, "smooth", "popin 80%")
anim("layersOut", true, 5, "spring", nil, "smooth", "popin 50%")
